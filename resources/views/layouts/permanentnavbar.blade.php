...
<head>
    ...
    <meta property="og:url" content="https://invest.untapped-global.com/"/>
    <title>Untapped Inc</title>
    <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "Organization",
      "url": "http://invest.untapped-global.com",
      "logo": "https://invest.untapped-global.com/untappedlogo.png"
    }
    ...
    <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "WebSite",
      "url": "https://www.invest.untapped-global.com/",
      "potentialAction": {
        "@type": "SearchAction",
        "target": "https://www.invest.untapped-global.com/search?q={search_term_string}",
...
<div>
    <div class="mobile-navbar-wrapper">
        <!-- header begin -->
        <div class="header header-fixed fadeInDown animated">
            <div class="top">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6">
                            <div class="welcome-text">
                                <p>Welcome to Untapped</p>
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 d-xl-flex d-lg-flex d-block align-items-center">
                            <div class="user-panel">
                                <span><a href="#" class="login">Login</a>or</span><a href="#" class="btn-hyipox-small">Register</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-10">
                            <div class="about-widget">
                                ...
                                <p>Untapped helps entrepreneurs in frontier markets meet the needs of their growing
                                    communities. Unlike small businesses in rich countries, entrepreneurs in developing
                                    markets have limited access to financing. This makes essential services such as
                                    clean
                                    water, affordable healthcare, a safe motorcycle ride, or healthy food more expensive
                                    and
                                    harder to find. It impacts everyone, but especially the poorest.</p>
