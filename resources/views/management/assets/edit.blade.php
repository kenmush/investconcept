        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('myassets.update',$asset['id']) }}" enctype="multipart/form-data"
                              method="post">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="use_case"
                                               ...
                                               name="use_case" value="{{ $asset['use_case'] }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="ticket"
                                               ...
                                               name="ticket" value="{{ $asset['ticket'] }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="return_percentage"
                                               ...
                                               name="return_percentage" value="{{ $asset['return_percentage'] }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="impact"
                                               ...
                                               name="impact" value="{{ $asset['impact'] }}"
                            ...
                            <div class="row float-right">
                                <div class="float-right">
                                    <button class="float-right btn-sm btn btn-secondary">Update Asset</button>
                                </div>
                            </div>
                        </form>
                    </div>
