            ...
            <div class="d-flex flex-column-fluid flex-column justify-content-between py-9 px-7 py-lg-13 px-lg-35">
                ...
                <div class="d-flex flex-column-fluid flex-column flex-center">
                    ...
                    <div class="login-form login-signin py-11">
                        <!--begin::Form-->
                        <form class="form" novalidate="novalidate" method="post" action="{{ route('resetpassword') }}">
                            @csrf
                            <!--begin::Title-->
                            ...
                            <div class="text-center pt-2">
                                ...
                                border-color:rgb(237,127,51)"
                                        class="btn font-weight-bolder font-size-h6 px-8 py-4 my-3">Reset
                                    Password</button>
                            </div>
                            <!--end::Action-->
                        </form>
                    ...
                    <div class="login-form login-signup pt-11">
                        <!--begin::Form-->
                        <form class="form" novalidate="novalidate" action="{{ route('resetpassword') }}" method="post">
