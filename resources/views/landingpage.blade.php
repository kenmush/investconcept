            ...
            <div class="row align-items-center mt-4">
                ...
                <div class="col-12 col-md-6 dtr-sm-mb-30px">
                    ...
                    <h4 style="color:#071e55;" class="dtr-mb-4 wow fadeInUp" data-wow-delay="0.4s">
                        Grow your wealth with others. Contribute to emerging markets development while making a healthy
                        return
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-12 text-center margin-bottom-10">
                    ...
                    <h2 class="section-title" style="margin-bottom: 50px;">Three Reasons for
                        <strong><small>UNTAPPED</small></strong>
                        Capital</h2>
