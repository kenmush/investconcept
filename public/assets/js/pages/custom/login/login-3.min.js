...
var KTLogin = {
    init: function () {
        ...
        t = KTUtil.getById("kt_login_singin_form"), KTUtil.attr(t, "action"), i = KTUtil.getById("kt_login_singin_form_submit_button"), t && FormValidation.formValidation(t, {
            ...
            var t, i = KTUtil.getById("kt_login"), e = KTUtil.getById("kt_login_signup_form"), r = [];
            e && (r.push(FormValidation.formValidation(e, {
                fields: {
                    ...
                    password: {validators: {notEmpty: {message: "Password is required"}}},
                    password-confirm: {validators: {notEmpty: {message: "Password is required"}}},
                    email: {
                        validators: {
                            notEmpty: {message: "Email is required"},
                            emailAddress: {message: "The value is not a valid email address"}
                ...
                plugins: {trigger: new FormValidation.plugins.Trigger, bootstrap: new FormValidation.plugins.Bootstrap}
            })), (t = new KTWizard(i, {startStep: 1, clickableSteps: !1})).on("beforeNext", function (i) {
